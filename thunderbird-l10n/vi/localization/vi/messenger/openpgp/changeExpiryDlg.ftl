...
info-explanation-1-complex = Khóa OpenPGP này bao gồm một khóa chính và ít nhất một khóa con <b>với ngày hết hạn khác nhau</b>.
select-key-prompt = Khoá để thay đổi:
...
partial-label-expired = đã hết hạn
partial-label-never-expires = không bao giờ hết hạn
partial-label-expires = hết hạn: { $date }
