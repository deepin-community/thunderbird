about-networking-title = Относно мрежата
about-networking-http = HTTP
about-networking-http-clear-cache-button = Изчистване на склада на HTTP
about-networking-sockets = Сокети
about-networking-dns = DNS
about-networking-dns-clear-cache-button = Изчистване на склада на DNS
about-networking-dns-trr-url = Адрес на DoH
about-networking-dns-trr-mode = Режим на DoH
about-networking-dns-suffix = Наставка за DNS
...
about-networking-originAttributesSuffix = Изолиращ ключ
about-networking-flags = Допълнителни флагове
...
about-networking-networkid = Идентификатор на мрежа
about-networking-networkid-id = Идентификатор на мрежа
about-networking-moved-about-logging = Страницата е преместена на <a data-l10n-name="about-logging-url">about:logging</a>.
