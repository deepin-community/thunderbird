...
sandbox-missing-unprivileged-namespaces = Некоторые функции безопасности { -brand-short-name } могут обеспечивать меньшую защиту на вашей текущей операционной системе.
