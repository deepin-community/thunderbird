...
info-explanation-1-complex = Denne OpenPGP-nøgle består af en primærnøgle og mindst én undernøgle <b>med en anden udløbsdato</b>.
select-key-prompt = Nøgle der skal ændres:
...
partial-label-expired = udløbet
partial-label-never-expires = udløber aldrig
partial-label-expires = udløber: { $date }
