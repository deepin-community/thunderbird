...
sandbox-missing-unprivileged-namespaces = Disa veçori sigurie të { -brand-short-name }-it mund të ofrojnë më pak mbrojtje në sistemin tuaj operativ të tanishëm.
