...
remove-primary-password-warning1 = Fjalëkalimi juaj i Përgjithshëm përdoret për të mbrojtur të dhëna rezervat, bie fjala, kredenciale hyrjesh dhe fjalëkalime.
