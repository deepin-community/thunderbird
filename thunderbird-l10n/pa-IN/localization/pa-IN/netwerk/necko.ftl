...
network-connection-status-connected = …{ $host } ਨਾਲ ਕਨੈਕਟ ਹੈ
...
network-connection-status-tls-handshake = { $host } ਨਾਲ TLS ਹੈਂਡਸ਼ੇਕ ਕੀਤਾ ਜਾ ਰਿਹਾ ਹੈ…
network-connection-status-tls-handshake-finished = { $host } ਲਈ TLS ਹੈਂਡਸ਼ੇਕ ਪੂਰਾ ਹੋਇਆ…
