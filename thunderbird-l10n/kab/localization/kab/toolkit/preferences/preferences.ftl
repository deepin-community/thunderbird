...
settings-pp-erased-ok = Tsefḍeḍ awal-ik n uεeddi agejdan. Awalen n uεeddi akked tsura tusligin n yiselkinen i yettwasferken sɣur { -brand-short-name } ur ttwammestnen ara.
settings-pp-not-wanted = Γur-k! Tgemneḍ ur tesseqdaceḍ ara awal n uεeddi agejdan. Awalen n uεeddi akked tsura tusligin n yiselkinen i yettwasferken sɣur { -brand-short-name } ur ttwammestnen ara.
