...
auth-success-them = 상대방이 성공적으로 신분을 확인했습니다. 사용자도 질문을 통해 상대방의 신원을 확인할 수 있습니다.
...
alert-gone-insecure = { $name } 님과의 암호화된 대화가 종료되었습니다.
...
state-not-private = 현재 대화는 비공개가 아닙니다.
state-generic-not-private = 현재 대화는 비공개가 아닙니다.
state-unverified = { $name }의 신원이 확인되지 않아서 현재의 대화는 암호화 되었지만 비공개가 아닙니다.
state-generic-unverified = 아직 일부 신원이 확인되지 않았기 때문에 현재 대화는 암호화되었지만 비공개가 아닙니다.
state-private = { $name }의 신원이 확인되었습니다. 현재 대화는 암호화되어 있으며 비공개입니다.
state-generic-private = 현재 대화는 암호화되었고 비공개입니다.
state-finished = { $name } 님이 암호화 된 대화를 종료했습니다. 나도 똑같이 해야 합니다.
state-not-private-label = 안전하지 않음
