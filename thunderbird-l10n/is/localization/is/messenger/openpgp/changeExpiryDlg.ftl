...
info-explanation-1-complex = Þessi OpenPGP-lykill samanstendur af aðallykli og að minnsta kosti einum undirlykli <b>með mismunandi gildistíma</b>.
select-key-prompt = Lykill sem á að breyta:
...
usage-label = Notkun:
algorithm-label = Reiknirit:
created-label = Búið til:
...
partial-label-expired = útrunninn
partial-label-never-expires = rennur aldrei út
partial-label-expires = rennur út: { $date }
